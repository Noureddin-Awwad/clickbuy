...
class UpdateNameController extends GetxController{
  ...
  Future<void> updateUserName() async {
    try{
      ...
      // Start Loading
      NFullScreenLoader.openLoadingDialog('We are updating you information...', NImage.docerAnimation);
     ...
     // Form Validation
      ...
      NLoaders.successSnackBar(title: 'Congratulations' , message: 'Your Name has been updated.');
